...
import { Search, MapPin, ChevronRight, Shield, CheckCircle, Star, Clock } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#fafafa]">
      <div className="relative overflow-hidden pt-12 pb-24 md:pt-20 md:pb-32">
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
          ...
          <div className="glass rounded-[2.5rem] p-4 md:p-6 max-w-2xl mx-auto shadow-2xl border-white/40">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {TRADES.map((t) => (
            <button key={t.id} onClick={() => { setSelectedTrade(t.id); window.scrollTo({ top: 0, behavior: 'smooth' }); }} className="glass p-8 rounded-[2rem] text-left hover:scale-[1.05] transition-all group border-white/40">
              <div className="w-14 h-14 bg-gray-50 rounded-2xl flex items-center justify-center text-3xl group-hover:bg-white transition-colors mb-6">{t.icon}</div>
